...
3. For detailed instructions on setting up Armada, refer to the [Armada operator's README](https://github.com/armadaproject/armada-operator)

### Configuration File
You need to have a `clusters.xml` file that defines your Kubernetes cluster connection. An example is provided in this repository:
